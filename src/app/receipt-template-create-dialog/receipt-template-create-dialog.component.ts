...
@Component({
  selector: 'app-receipt-template-create-dialog',
  templateUrl: './receipt-template-create-dialog.component.html',
  styleUrls: ['./receipt-template-create-dialog.component.css']
})
export class ReceiptTemplateCreateDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<ReceiptTemplateCreateDialogComponent>) { }
